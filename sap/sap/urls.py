...
from personas.views import detallePersona, detalleDomicilio
from webapp.views import bienvenido, nuevaPersona, editarPersona, eliminarPersona, nuevoDomicilio
